...
import { STRIPE_PUBLIC_KEY, DONATION_AMOUNT } from '../config/stripe';
      ...
      lineItems: [
        {
          price_data: {
            currency: 'eur',
            product_data: {
              name: 'Donatie voor Studiefinanciering Calculator',
              description: 'Steun de ontwikkeling van deze tool',
            },
